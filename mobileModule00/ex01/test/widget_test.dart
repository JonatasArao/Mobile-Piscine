...
void main() {
  testWidgets('Ex01Text displays correct text', (WidgetTester tester) async {
    await tester.pumpWidget(
      const MaterialApp(home: Ex01Text(currentText: 'A simple text')),
    );

    expect(find.text('A simple text'), findsOneWidget);
  });

  testWidgets('Ex01Button displays correct text and prints message on press', (
    WidgetTester tester,
  ) async {
    await tester.pumpWidget(
      MaterialApp(
  ...
  testWidgets('Ex01 widget tree is built correctly', (
    WidgetTester tester,
  ) async {
  ...
  testWidgets('Ex01Text toggles text on button press', (
    WidgetTester tester,
  ) async {
    await tester.pumpWidget(const Ex01());
  ...
  testWidgets('Ex01Button has correct initial style', (
    WidgetTester tester,
  ) async {
    await tester.pumpWidget(
      MaterialApp(
