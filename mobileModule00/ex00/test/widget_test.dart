...
void main()
{
	testWidgets('Ex00Text displays correct text', (WidgetTester tester) async
		{
			await tester.pumpWidget(const MaterialApp(
				home: Ex00Text(currentText: 'A simple text'),
			));
	...
	testWidgets('Ex00Button displays correct text and prints message on press', (WidgetTester tester) async
		{
			await tester.pumpWidget(const MaterialApp(
				home: Ex00Button(buttonText: 'Click me', pressedMessage: 'Button pressed'),
			));
	...
	testWidgets('Ex00 widget tree is built correctly', (WidgetTester tester) async
	{
